...
xgb = xgboost.XGBRFClassifier(learning_rate=0.05, max_depth=8, scale_pos_weight=10, n_estimators=100, n_jobs=8, nthread=-1, subsample=.6, verbosity=1,
                            colsample_bylevel=.9, colsample_bynode=.9, colsample_bytree=.9, gamma=1, base_score=.5, min_child_weight=1, max_delta_step=10) ##n_estimators=1000, learning_rate=0.05
